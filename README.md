...
这个项目从 2024 年开始断断续续维护，到现在也快两年了。期间收到过很多朋友的 Star

所以也觉得有必要出来说明一下，让大家更了解这个项目。

🍀 所有资源和介绍都在网站：**132130.xyz** 获取！ 网站QQ交流群：**680226578**

网站没有会员，登入注册都不用，甚至连打赏渠道都没有开通。

从项目开始到现在，收益一直是 **0**。

🍀 至于网盘分享，由于本身就是永久免费的公益项目，网站用的低配服务器，**给直链直接下载，流量和带宽成本我是不想承受的**

资源搜集分享时大佬用啥网盘我也跟着用呗。方便同步更新（网盘都是有通知）

🍀 各位可以把本项目看做导航类，觉得好用就支持原作者，遇到任何问题也请向原作者反馈，或者**自行决定使用与否**

我只是把平时觉得好用的推荐出来，希望大家找资源更方便些，仅此而已

**免费发电更新内容只是我的个人兴趣，偶尔更新还行，但是免费客服这份工作，我终究只是个普通人！**

🍀 电视、解压、软件+接口等相关问题，请不要在评论区或群里问我了，请自行通过浏览器搜索解决。
...
**2026/09/08 更新软件：** PeekPro/PeekPili（羊壳）最终版，费力开发维护，免费提供使用的软件也遭到举报，作者心寒宣布停更跑路。

**2026/08/29 更新软件：** 蜂蜜影视（FongMi）迎来版本更新，从 v5.6.1 升级至 v5.6.3

**2026/08/29 更新软件：** NewBox 影视壳子又更新，版本从 v1.9.1 升级至 v1.9.8

**2026/08/22 更新软件：** WebHomeTV 实验室版 / 墨影视 实验室版

**2026/08/22 更新软件：** EasyBox 最新版，专为手机端打造的影视播放器，基于TVbox开发

**2026/08/22 更新软件：** MediaMix（原512影视）最终版，内置浏览器功能，适配手机+TV双端

**2026/08/20 更新软件：** 影视仓又迎来版本更新！手机版 v3.3.6 → v3.3.7，电视端 v6.2.6 → v6.2.7 （含支持安卓4的影视仓）

**2026/08/20 更新软件：**  WebHomeTV 迎来版本更新，从 v5.5.6-beta-202608052028 升级至 v5.5.6-202608132137、本次从 Beta 版本更新到了正式版本

**2026/08/20 更新软件：** PeekPro/PeekPili（羊壳）迎来版本更新，从 v1.5.1 升级至 v1.5.3

**2026/08/20 更新软件：** 蜂蜜影视（FongMi）迎来版本更新，从 v5.5.9 升级至 v5.6.0，带来了一些功能优化与体验改进

**2026/08/20 更新软件：** NewBox 影视壳子又更新了！版本从 v1.8.5 升级至 v1.9.1，这次跨了两个小版本，如果你还在使用旧版，建议更新到最新版体验一下。

**2026/08/20 更新软件：** TVBox 白盒 Q版迎来新版本：从 v20260730-2340 升级至 v20260805-1744

**2026/08/09 更新软件：** 影视仓迎来版本更新，手机版从 v3.3.1 升级至 v3.3.6，电视端同步更新至 v6.2.6（原 v6.2.5）,还新增支持安卓4的影视仓

**2026/08/08 更新软件：** PeekPro/PeekPili（羊壳）迎来版本更新，从 v1.5.0 升级至 v1.5.1，本次主要优化交互体验、阅读功能以及桌面端操作

**2026/08/08 更新软件：** TVFileBox 最新版，电视盒子的轻量文件管理与局域网上传，兼容 Android 4.0 老设备

**2026/08/08 更新软件：** 蜂蜜影视（FongMi）迎来版本更新，从 v5.5.9 升级至 v5.6.0，带来了一些功能优化与体验改进，建议正在使用的小伙伴更新体验。

**2026/08/07 更新软件：** WebHomeTV 最新版，可自由定制首页的影视壳子，颜值与体验感拉满！

**2026/08/07 更新软件：** 蜂蜜影视（FongMi）最新 v5.5.9，基于TVBox的开源壳子，简约稳定~

**2026/08/06 更新软件：** UZ影视又有更新了  版本 v1.6.76 -> v1.6.77

**2026/08/06 更新软件：** 电视文件管理器 养老版丨功能强大、小巧好用丨方便影视本地包导入、安装软件、空间分析

**2026/08/06 更新软件：** Projectivy Launcher 高级版丨封神级电视桌面，极简无广告，可高度自定义

**2026/08/05 更新软件：** PeekPro/PeekPili（羊壳）最新版丨支持影视+音乐+漫画+小说等 全能壳子丨附新手指南

**2026/08/05 更新软件：** NewBox影视壳子有更新 v1.7.5 -> v1.8.5

**2026/08/05 更新软件：** TVBox 白盒/白壳（Q版）最新版丨设备兼容性强，开源好用的影视壳子！

**2026/07/12 更新软件：** 4K影视，软件内置多条蓝光、4K 等高清线路，加载速度快，播放流畅稳定

**2026/07/11 更新软件：** 影视仓作者这几天又有更新，手机版最新为v3.3.1，电视端最新为v6.2.5

**2026/07/11 更新软件：** 洛雪音乐 LX Music 最新全版本，附超全在线音源和教程丨支持安卓+电脑

**2026/07/10 更新软件：** 魔方4K（魔方影视）最新版是一款比较受欢迎的安卓影视软件，日常追剧、观影都能很好满足。

**2026/07/09 更新软件：** UZ影视最新版，支持安卓、TV、iOS、电脑丨附使用教程和订阅源接口

**2026/07/08 更新软件+接口：** 更新TVBox最新配置接口+本地仓、OK影视各版本合集、稀饭追剧TV针对电视大屏进行了专门优化，新人也能轻松上手

**2026/07/07 更新软件：** 王子电视 是一款我比较推荐的电视直播软件，播放流畅不卡顿，界面简洁，操作方便，就算是家里的老人也能轻松上手。

**2026/07/07 更新软件：** 影视仓全版本合集丨支持手机+电视，基本是必备软件了

**2026/07/06 更新软件：** 最新TVBox白盒版，电视+手机都能装，使用体验不错，和OK感觉不相上下

**2026/07/05 更新软件：** 我的电视更新，支持蓝光画质，播放流畅，几乎秒加载不卡顿，各类频道也是十分齐全，推荐安装
